    ...
    <div className='col-auto'>
      <div className="card" style={{width: '18rem', height: '28em'}}>
        ...
        <div className="card-body">
          ...
          <select id='chooseType' className="form-select mb-2" aria-label="Choose a Media Type" required>
          ...
          <input id="newTitle" className="form-control mb-2" type="text" placeholder="Title" aria-label="Title" required />
          <textarea className="form-control mb-2" id="newReview" placeholder="Enter a short review" rows="3" required ></textarea>
          <p>I would reccomend this...</p>
          <div class='mb-2 d-flex justify-content-between'>
            <input type="radio" className="btn-check" name="options" id="rating-alotl" autocomplete="off"/>
            <label className="btn btn-success" style={{width: '45%'}} for="rating-alotl">alotl</label>
            
            <input type="radio" className="btn-check"  name="options" id="rating-not-alotl" autocomplete="off" />
            <label className="btn btn-danger" style={{width: '45%'}} for="rating-not-alotl">not alotl</label>
          </div>
